...
<CardGroup cols={2}>
  <Card title="Source Code" icon="github" href="https://github.com/pdugan20/rewind/tree/main/mcp-server">
    Browse on GitHub
  </Card>
  <Card title="npm Package" icon="npm" href="https://www.npmjs.com/package/rewind-mcp-server">
    rewind-mcp-server
  </Card>
</CardGroup>

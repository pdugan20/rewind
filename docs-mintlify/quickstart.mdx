...
The activity feed uses cursor-based pagination instead -- see the [Feed API reference](/api-reference/feed/cross-domain-activity-feed) for details.
...
Every endpoint is published as a machine-readable [OpenAPI 3.1 document](/openapi-spec) -- use it to generate clients, drive agent tools, or import into Postman.
...
- [Reading](/domains/reading) -- Instapaper
- [Attending](/domains/attending) -- Google Calendar and Gmail

...
const SERVER_INSTRUCTIONS = [
  ...
  '3. Fetch @rewind://article/{id} and read the excerpt before answering when in',
  '   doubt. The excerpt is the source of truth.',
  '4. Quote a short phrase from the excerpt when citing a fact.',
  '',

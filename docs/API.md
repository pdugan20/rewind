...
{
  "data": [
    { "id": 1, "name": "portfolio-prod", "scope": "read", "key_prefix": "rw_live_", "key_hint": "...ef00", "last_used_at": "2026-03-09T14:00:00Z", "request_count": 4521, "is_active": true }
  ]
}
```
...
{
  "period": "7day",
  "listening": { "scrobbles": 287, "unique_artists": 34, "top_artist": "Radiohead" },
...
```json
{
  ...
  "results": {
    "listening": {
      ...
      "albums": [{ "id": 88, "name": "OK Computer", "artist": "Radiohead", "playcount": 312 }]
    },
    "collecting": {
      "releases": [{ "id": 1, "title": "OK Computer", "format": "Vinyl", "year": 1997 }]
    },
    "running": { "activities": [] },
    "watching": { "movies": [] }
  },
...
```json
{
  ...
  "track": {
    ...
    "album": { "id": 88, "name": "Kid A", "image_url": "https://cdn.rewind.rest/listening/albums/kid-a-mbid/original.jpg", "thumbhash": "abc123==", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f" },
  ...
  "data": [
    {
      "name": "Everything In Its Right Place",
      "artist": { "id": 42, "name": "Radiohead" },
      "album": { "id": 88, "name": "Kid A", "image_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f" },
...
```json
{
  "period": "3month",
  "data": [
    { "rank": 1, "id": 42, "name": "Radiohead", "playcount": 312, "image_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f", "url": "https://www.last.fm/music/Radiohead" }
  ],
...
```json
{
  "period": "3month",
  "data": [
    { "rank": 1, "id": 88, "name": "OK Computer", "detail": "Radiohead", "playcount": 78, "image_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f", "url": "..." }
  ],
...
```json
{
  "current": { "days": 45, "start_date": "2026-01-24", "total_scrobbles": 1234 },
  "longest": { "days": 312, "start_date": "2024-02-01", "end_date": "2024-12-09", "total_scrobbles": 8901 }
}
```
...
```json
{
  ...
  "top_albums": [
    { "id": 88, "name": "OK Computer", "playcount": 312 }
  ],
  "top_tracks": [
    { "id": 201, "name": "Paranoid Android", "playcount": 78 }
  ]
}
```
...
{
  "data": [
    { "year": 2026, "total_runs": 42, "total_distance_mi": 198.3, "total_elevation_ft": 12450, "avg_pace": "8:05/mi", "longest_run_mi": 13.1, "race_count": 1 },
    { "year": 2025, "total_runs": 210, "total_distance_mi": 1105.2, "total_elevation_ft": 67800, "avg_pace": "8:18/mi", "longest_run_mi": 26.2, "race_count": 4 }
  ]
}
```
...
{
  "data": [
    { "distance": "mile", "distance_label": "Mile", "time": "6:42", "time_s": 402, "pace": "6:42/mi", "date": "2019-09-14", "activity_id": 456, "activity_name": "Fall 5K Race" },
    { "distance": "5k", "distance_label": "5K", "time": "22:15", "time_s": 1335, "pace": "7:10/mi", "date": "2019-09-14", "activity_id": 456, "activity_name": "Fall 5K Race" },
    { "distance": "10k", "distance_label": "10K", "time": "47:30", "time_s": 2850, "pace": "7:39/mi", "date": "2018-10-20", "activity_id": 321, "activity_name": "Bridge Run 10K" },
    { "distance": "half_marathon", "distance_label": "Half Marathon", "time": "1:45:22", "time_s": 6322, "pace": "8:03/mi", "date": "2022-03-05", "activity_id": 789, "activity_name": "Spring Half Marathon" },
    { "distance": "marathon", "distance_label": "Marathon", "time": "3:52:10", "time_s": 13930, "pace": "8:52/mi", "date": "2023-11-12", "activity_id": 1001, "activity_name": "Philly Marathon" }
  ]
}
```
...
{
  "data": [
    { "id": 1234, "strava_id": 12345678, "name": "Morning Run", "date": "2026-03-09T07:15:00-05:00", "distance_mi": 5.2, "duration": "42:30", "pace": "8:10/mi", "elevation_ft": 234, "heartrate_avg": 152, "city": "Philadelphia", "polyline": "encodedString...", "is_race": false }
  ]
}
```
...
```json
{
  "activity_id": 1234,
  "data": [
    { "mile": 1, "time": "8:05", "time_s": 485, "elevation_ft": 45, "heartrate_avg": 148 },
    { "mile": 2, "time": "8:12", "time_s": 492, "elevation_ft": -12, "heartrate_avg": 155 }
  ]
}
```
...
{
  "data": [
    { "id": "g12345", "name": "Nike Pegasus 40", "brand": "Nike", "model": "Pegasus 40", "distance_mi": 342.5, "is_retired": false }
  ],
...
```json
{
  "unit": "mi",
  "series": {
    "2026": [{ "day": 1, "cumulative": 0 }, { "day": 2, "cumulative": 5.2 }],
    "2025": [{ "day": 1, "cumulative": 0 }, { "day": 3, "cumulative": 6.1 }]
  }
}
```
...
```json
{
  "window": 30,
  "data": [
    { "date": "2026-03-01", "avg_pace_s": 497, "avg_pace": "8:17/mi" }
  ]
}
```
...
{
  "data": [
    { "city": "Philadelphia", "state": "PA", "country": "US", "count": 1200, "total_mi": 5600.2 },
    { "city": "New York", "state": "NY", "country": "US", "count": 45, "total_mi": 210.5 }
  ]
}
```
...
```json
{
  ...
  "longest": { "days": 45, "start_date": "2024-06-01", "end_date": "2024-07-15", "total_mi": 198.7 }
}
```
...
{
  "data": [
    { "activity_id": 1001, "name": "Philly Marathon", "date": "2023-11-12", "distance": "marathon", "distance_label": "Marathon", "time": "3:52:10", "pace": "8:52/mi", "city": "Philadelphia" }
  ],
  "summary": { "total": 23, "by_distance": { "mile": 2, "5k": 8, "10k": 6, "half_marathon": 5, "marathon": 2 } }
}
```
...
{
  "data": [
    { "id": 1, "title": "The Grand Budapest Hotel", "year": 2014, "director": "Wes Anderson", "genres": ["Comedy", "Drama"], "duration_min": 99, "rating": "R", "poster_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f", "watched_at": "2026-03-08T21:00:00Z", "imdb_id": "tt2278388" }
  ]
}
```
...
{
  "data": [
    { "name": "Wes Anderson", "count": 9, "movies": ["The Grand Budapest Hotel", "Moonrise Kingdom", "The Royal Tenenbaums"] },
    { "name": "Denis Villeneuve", "count": 7, "movies": ["Dune", "Arrival", "Blade Runner 2049"] }
  ]
}
```
...
{
  "data": [
    { "id": 1, "discogs_id": 12345678, "title": "OK Computer", "artists": ["Radiohead"], "year": 1997, "format": "Vinyl", "format_detail": "2xLP, Album, Reissue, 180g", "label": "XL Recordings", "genres": ["Electronic", "Rock"], "styles": ["Alternative Rock"], "cover_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f", "date_added": "2024-05-10T14:00:00Z", "rating": 5, "discogs_url": "https://www.discogs.com/release/12345678" }
  ],
...
{
  "data": [
    { "name": "Radiohead", "count": 8, "releases": ["OK Computer", "Kid A", "In Rainbows"] }
  ]
}
```
...
```json
{
  "data": [
    {
      "collection": { "id": 1, "title": "OK Computer", "artists": ["Radiohead"], "format": "Vinyl", "cover_url": "...", "thumbhash": "...", "dominant_color": "#1a2b3c", "accent_color": "#4d5e6f" },
      "listening": { "album_id": 88, "play_count": 312, "last_played": "2026-03-08T22:00:00Z", "match_type": "exact", "match_confidence": 1.0 }
    }
  ],
  "summary": { "total_matches": 67, "listen_rate": 0.46, "unlistened_count": 78 },
